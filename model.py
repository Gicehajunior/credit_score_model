...
def data_split(dataframe):
    ...
    x_feature_sets = correlated_dataframe[feature_sets_selected]
...
def apply_error_matrix_algorithm(dataframe):
    ...
    plot.figure()
    error_visualization.error_visualize(error_matrix, classes=["BAD"], title='Confusion matrix - Logistic Regression Algorithm')
